...
namespace _01_Inheritance
{
    namespace vehicleType2
    {
        public class VehicleType2 : VehicleType1
        {
            ...
            // New static methods.
            public static void printVehicleMake(VehicleType2 vehicle)
            {
                Console.WriteLine(vehicle.Make);
            }
            public static void printVehicleColor(VehicleType2 vehicle)
            {
                Console.WriteLine(vehicle.Color);
            }
            public static void printVehicleIsRunning(VehicleType2 vehicle)
            {
                Console.WriteLine(vehicle.IsRunning);
            }
            public static void printVehicleFuelLevel(VehicleType2 vehicle)
            {
