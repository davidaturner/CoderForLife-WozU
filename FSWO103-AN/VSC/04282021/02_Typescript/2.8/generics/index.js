...
be any type.
*/
function identity_ex1(argument) {
    return argument;
}
...
*/
/* Example 2 */
function identity_ex2(argument) {
    console.log("Ex2: " + argument);
    return argument;
}
identity_ex2("Kara");
/* Example 3 */
function identify_ex3(argument) {
    var argType = '';
...
function identityCheck1(argument) {
    console.log("Ex4: " + argument.length);
    return argument;
}
var groceryList1 = ['bread', 'milk', 'butter', 'cookies'];
var groceryList2 = ['bread', 'milk', 'butter', 'cookies'];
identityCheck1(groceryList1);
identityCheck1(groceryList2);
function identityCheck2(argument) {
    console.log("EX5: " + argument.length);
    return argument;
}
var groceryList3 = ['soup', 'cream', 'peanuts'];
